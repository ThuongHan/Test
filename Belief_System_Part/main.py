...
def get_paths(extractor_method: str) -> tuple[Path, Path, Path]:
    ...
    repo        = PROCESSED_DIR / f"belief_repository_{extractor_method}.json"
...
def run_step3(beliefs_raw_path: Path, repo_path: Path) -> None:
    """
    Step 3 — Structuring
...
def main(steps: list[int], extractor_method: str) -> None:
    ...
    step_runners = {
        ...
        3: lambda: run_step3(BELIEFS_RAW_PATH, REPO_PATH),
